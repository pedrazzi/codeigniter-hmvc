...
$lang['form_validation_min_length'] = 'O campo <strong>{field}</strong> deve ter pelo menos <strong>{param}</strong> caractere(s).';
$lang['form_validation_max_length'] = 'O campo <strong>{field}</strong> ultrapassou o limte de <strong>{param}</strong> caractere(s).';
...
$lang['form_validation_matches'] = 'O campo <strong>{field}</strong> não é igual ao campo <strong>{param}</strong>.';
...
$lang['form_validation_user_check'] = 'O <strong>Login</strong> e <strong>Senha</strong> digitados são incorretos.';
$lang['form_validation_login_check'] = 'Este <strong>Email</strong> já está cadastrado por outro usuário.';
$lang['form_validation_captcha_check'] = "<i class=\"fa fa-info-circle\"></i> O <strong>%s</strong> foi digitado incorretamente.";
